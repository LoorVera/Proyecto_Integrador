...
## 📁 Estructura
```
index.html         → Landing principal: hero de video, carrusel de destinos, experiencias
                      de viajeros, planes de pago, login, registro y contacto
organizador.html    → Organizador de viaje: calcula presupuesto e itinerario día a día
mapa.html           → Mapa interactivo de provincias por región, con hoteles por zona
...
2. Navega a `mapa.html` para explorar por región o a `organizador.html` para planificar un viaje.
